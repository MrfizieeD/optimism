...
export interface DeployConfig {
  /**
   * Address of the account to initially own the DrippieRedd account. You should make this the same
   * address on all chains if you want the receiver to be deployed at the same address everywhere.
   */
  initialDrippieReddOwner: string
}
